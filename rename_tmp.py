...
#2017-08-30 fixed a bug while the file is not compress completed yet the script will rename it,this cause the tar file broken
...
class groupfile:
	...
	def renametmp(self,tmppath,tmpdestpath):
		...
		logging.basicConfig(filename='/var/log/renametmp.log',level=logging.ERROR,format='%(asctime)s %(message)s')
			...
			for file in files:
				if file.startswith('SC') and file.endswith('tmp'):
					try:
						...
						logging.error('while rename the tmp file %s,the file is not compress complete,ignore it',file)
...
def main():
	...
	"""
	a = groupfile()
	filepath = '/data04/unicom/group'
	p1 = Process(target=a.renametmp,args=(filepath,'group_gnc'))
	p2 = Process(target=a.renametmp,args=(filepath,'special/ciloc'))
	p3 = Process(target=a.renametmp,args=(filepath,'special/mmecdr'))
	p4 = Process(target=a.renametmp,args=(filepath,'group_s11'))
	p5 = Process(target=a.renametmp,args=(filepath,'group_s6a'))
	p6 = Process(target=a.renametmp,args=(filepath,'group_sgs'))
	p7 = Process(target=a.renametmp,args=(filepath,'group_iucs'))
	p8 = Process(target=a.renametmp,args=(filepath,'group_gn/gn_email'))
	p9 = Process(target=a.renametmp,args=(filepath,'group_gn/gn_others'))
	p10 = Process(target=a.renametmp,args=(filepath,'group_gn/gn_gen'))
	p11 = Process(target=a.renametmp,args=(filepath,'group_gn/gn_ftp'))
	p12 = Process(target=a.renametmp,args=(filepath,'group_gn/gn_p2p'))
	p13 = Process(target=a.renametmp,args=(filepath,'group_gn/gn_mms'))
	p14 = Process(target=a.renametmp,args=(filepath,'group_gn/gn_dns'))
	p15 = Process(target=a.renametmp,args=(filepath,'group_gn/gn_http'))
	p16 = Process(target=a.renametmp,args=(filepath,'group_gn/gn_voip'))
	p17 = Process(target=a.renametmp,args=(filepath,'group_gn/gn_rtsp'))
	p18 = Process(target=a.renametmp,args=(filepath,'group_s1u/s1u_email'))
	p19 = Process(target=a.renametmp,args=(filepath,'group_s1u/s1u_others'))
	p20 = Process(target=a.renametmp,args=(filepath,'group_s1u/s1u_gen'))
	p21 = Process(target=a.renametmp,args=(filepath,'group_s1u/s1u_ftp'))
	p22 = Process(target=a.renametmp,args=(filepath,'group_s1u/s1u_p2p'))
	p23 = Process(target=a.renametmp,args=(filepath,'group_s1u/s1u_mms'))
	p24 = Process(target=a.renametmp,args=(filepath,'group_s1u/s1u_dns'))
	p25 = Process(target=a.renametmp,args=(filepath,'group_s1u/s1u_http'))
	p27 = Process(target=a.renametmp,args=(filepath,'group_s1u/s1u_voip'))
	p26 = Process(target=a.renametmp,args=(filepath,'specail/udpisms'))
	p28 = Process(target=a.renametmp,args=(filepath,'group_s1u/s1u_rtsp'))
	p29 = Process(target=a.renametmp,args=(filepath,'specail/csfb'))
	processlist = [p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11,p12,p13,p14,p15,p16,p17,p18,p19,p20,p21,p22,p23,p24,p25,p27,p28,p26,p29]
