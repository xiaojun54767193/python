...
def main():
	...
	"""
	a = groupfile()
	p1 = Process(target=a.compress('/data04/unicom/group','group_gn/gn_email'))
	p2 = Process(target=a.compress('/data04/unicom/group','group_gn/gn_others'))
	p3 = Process(target=a.compress('/data04/unicom/group','group_gn/gn_gen'))
	p4 = Process(target=a.compress('/data04/unicom/group','group_gn/gn_ftp'))
	p5 = Process(target=a.compress('/data04/unicom/group','group_gn/gn_p2p'))
	p6 = Process(target=a.compress('/data04/unicom/group','group_gn/gn_mms'))
	p7 = Process(target=a.compress('/data04/unicom/group','group_gn/gn_dns'))
	p8 = Process(target=a.compress('/data04/unicom/group','group_gn/gn_http'))
	p9 = Process(target=a.compress('/data04/unicom/group','group_gn/gn_voip'))
	p10 = Process(target=a.compress('/data04/unicom/group','group_gn/gn_rtsp'))
